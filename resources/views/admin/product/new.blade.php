<x-app-layout xmlns:livewire="http://www.w3.org/1999/html">
    <div class="card m-3 p-3">
        ...
        <form enctype="multipart/form-data" class="row g-2 m-3 p-1" action="/product" method="post">
            {{ csrf_field() }}
            <div class="mb-3 row">
                <label for="name" class="col-sm-2 col-form-label">Ürün Grubu</label>
                <div class="col-sm-10">
            ...
            <div class="mb-3 row">
                <label for="description" class="col-sm-2 col-form-label">Fiyat</label>
                <div class="col-sm-10">
