<x-app-layout xmlns:livewire="http://www.w3.org/1999/html">
    <div class="card m-3 p-3">
        ...
        <form  enctype="multipart/form-data" class="row g-2 m-3 p-1" method="post" action="/carousel/{{$carousel->id}}">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
            <div class="mb-3 row">
                <label for="name" class="col-sm-2 col-form-label">Banner Adı</label>
                <div class="col-sm-10">
